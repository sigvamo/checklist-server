	...
	sections : [ 
		{
          ...
          body : [
             ...
             { beforestep: 3, content: 'It is body text $$ORACLE_HOME$$ before step 3 <pre><code>function(a){return a+3}</code></pre> of the section body'},
