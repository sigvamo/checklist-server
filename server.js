...
var dataSource = {
	...
	body : [
             ...
             { beforesec: 2, content: 'It is body text before sec 2'},
             { beforesec: -1, content: 'It is body text of the end'}
          ],
	sections : [ 
		{
		  pos : 1,
